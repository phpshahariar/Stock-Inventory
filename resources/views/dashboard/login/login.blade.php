...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Apr 2018 04:55:14 GMT -->
<head>
    <meta charset="utf-8" />
...
<div class="login-cover">
    <div class="login-cover-image"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-1.jpg" data-id="login-cover-image" alt="" /></div>
...
<div id="page-container" class="fade">
    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                ...
                <small>Stock Inventory Login System</small>
            </div>
            <div class="icon">
        ...
        <div class="login-content">
            <form action="{!! route('login') !!}" method="POST" class="margin-bottom-0">
                ...
                <div class="login-buttons">
                    <button type="submit" name="btn" class="btn btn-success btn-block btn-lg">Login</button>
                </div>
                <div class="m-t-20">
    ...
    <ul class="login-bg-list">
        <li class="active"><a href="#" data-click="change-bg"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-1.jpg" alt="" /></a></li>
        <li><a href="#" data-click="change-bg"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-2.jpg" alt="" /></a></li>
        <li><a href="#" data-click="change-bg"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-3.jpg" alt="" /></a></li>
        <li><a href="#" data-click="change-bg"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-4.jpg" alt="" /></a></li>
        <li><a href="#" data-click="change-bg"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-5.jpg" alt="" /></a></li>
        <li><a href="#" data-click="change-bg"><img src="{!! asset('/dashboard/') !!}/assets/img/login-bg/bg-6.jpg" alt="" /></a></li>
    </ul>
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<script src="{!! asset('/dashboard/') !!}/assets/js/login-v2.demo.min.js"></script>
...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Apr 2018 04:55:20 GMT -->
</html>
